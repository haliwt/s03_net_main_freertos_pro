...
void MX_TIM1_Init(void)
{
 ...
 //ultrasonic PWM output
  ...
  sConfigOC.Pulse = 20; //pwm duty 50%
...
void MX_TIM3_Init(void)
{
  ...
  sConfigOC.OCMode = TIM_OCMODE_PWM1;
  sConfigOC.Pulse = 125; //pwm duty 50%
  sConfigOC.OCPolarity = TIM_OCPOLARITY_HIGH;
  sConfigOC.OCFastMode = TIM_OCFAST_DISABLE;
...
void MX_TIM16_Init(void)
{
  ...
  htim16.Init.Period = 39; //Fm = 1/(40)=0.025MHz= 25KHZ
  ...
  sConfigOC.OCMode = TIM_OCMODE_PWM1;
  sConfigOC.Pulse = gctl_t.gFan_pwm_duty_level;//20; //pwm_duty = 20/period= 50%
  sConfigOC.OCPolarity = TIM_OCPOLARITY_HIGH;
  sConfigOC.OCNPolarity = TIM_OCNPOLARITY_HIGH;
  sConfigOC.OCFastMode = TIM_OCFAST_DISABLE;
  sConfigOC.OCIdleState = TIM_OCIDLESTATE_RESET;
...
void MX_TIM14_Init(void)
{
  ...
  htim14.Init.Prescaler = 63;//63;// //F = 64/(31+1)=2MHZ
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  /* USER CODE END TIM16_MspPostInit 0 */
    ...
    */
    ...
    GPIO_InitStruct.Mode = GPIO_MODE_AF_OD;//PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
